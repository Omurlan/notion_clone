...
import React, { FC, FunctionComponent, memo, MemoExoticComponent } from 'react';
...
type ItemComponentFC = FC<ItemProps> & {
  Skeleton: FC<{ level?: number }>;
};

export const Item: ItemComponentFC = (props) => {
  const {
    onClick,
    icon: Icon,
    label,
  ...
  return (
    <div
      style={{
        paddingLeft: level ? level * 12 + 12 : 12,
      }}
      className={cn(
